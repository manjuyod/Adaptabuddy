...
raw_exercises (canonical_name, aliases, movement_pattern, equipment, is_bodyweight, primary_old_id, secondary_old_ids, tags, contraindications, default_warmups, default_warmdowns, media) AS (
  ...
  ('Leg Extension', '{}'::text[], 'unknown', '{}'::text[], false, 1, '{}'::int[], ARRAY['hypertrophy','engine_seed','nippard','isolation']::text[], '[]'::jsonb, '[]'::jsonb, '[]'::jsonb, '{}'::jsonb),
  ('Leg Press', '{}'::text[], 'horizontal_press', ARRAY['machine']::text[], false, 4, ARRAY[10,27]::int[], ARRAY['hypertrophy','engine_seed','nippard','compound']::text[], '[]'::jsonb, '[]'::jsonb, '[]'::jsonb, '{}'::jsonb),
  ('Leg Press Calf Raise', '{}'::text[], 'horizontal_press', ARRAY['machine']::text[], false, 16, '{}'::int[], ARRAY['hypertrophy','engine_seed','nippard','compound']::text[], '[]'::jsonb, '[]'::jsonb, '[]'::jsonb, '{}'::jsonb),
  ('Lying Leg Curl', '{}'::text[], 'elbow_flexion', ARRAY['dumbbell']::text[], false, 9, '{}'::int[], ARRAY['hypertrophy','engine_seed','nippard','isolation']::text[], '[]'::jsonb, '[]'::jsonb, '[]'::jsonb, '{}'::jsonb),
  ('Machine Chest Press', '{}'::text[], 'horizontal_press', ARRAY['machine']::text[], false, 4, ARRAY[10,27]::int[], ARRAY['hypertrophy','engine_seed','nippard','compound']::text[], '[]'::jsonb, '[]'::jsonb, '[]'::jsonb, '{}'::jsonb),
  ...
  ('Seated Leg Curl', '{}'::text[], 'knee_flexion', ARRAY['dumbbell']::text[], false, 9, '{}'::int[], ARRAY['hypertrophy','engine_seed','nippard','isolation']::text[], '[]'::jsonb, '[]'::jsonb, '[]'::jsonb, '{}'::jsonb),
  ('Single-Leg DB Hip Thrust', '{}'::text[], 'hinge', ARRAY['dumbbell']::text[], false, 13, ARRAY[15]::int[], ARRAY['hypertrophy','engine_seed','nippard','compound']::text[], '[]'::jsonb, '[]'::jsonb, '[]'::jsonb, '{}'::jsonb),
  ('Sissy Squat', '{}'::text[], 'squat', '{}'::text[], false, 14, ARRAY[13,15]::int[], ARRAY['hypertrophy','engine_seed','nippard','compound']::text[], '[]'::jsonb, '[]'::jsonb, '[]'::jsonb, '{}'::jsonb),
